'use strict';
// Originally by Kang Hong Jin, for Word News Chrome Extension
// https://github.com/kanghj/wordnews_chrome_extension
// Modified by Zhu Liang @paradite
...
function init(screenWidth, androidId) {
  ...
  var remembered = new HttpClient();
  console.log('set up http client');
