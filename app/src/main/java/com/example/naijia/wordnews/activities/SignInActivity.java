...
public class SignInActivity extends AppCompatActivity implements
    ...
    public void onStart() {
        ...
        if (opr.isDone()) {
            ...
            // Attempt to sign in the user silently.  Cross-device single sign-on will occur in this branch.
            showProgressDialog();
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            Log.d(TAG, "handleSignInResult: failed on google" + result.getStatus());
    ...
    private String userEmailFromBackend(String idToken) throws ExecutionException, InterruptedException, UnsupportedEncodingException, JSONException {
        ...
        try {
            parameters = "id_token=" + URLEncoder.encode(idToken, "UTF-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
            Log.e(TAG, "Error sending ID token to backend.");
            throw e;
        }
