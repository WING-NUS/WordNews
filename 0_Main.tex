...
% Tao: As the recent ACL paper~\cite{Iacobacci2016} has evaluated word embeddings for WSD, we have to change our phrase, e.g., it is not proper to say "no comparison".
