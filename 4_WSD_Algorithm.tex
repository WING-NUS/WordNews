...
translation $c$.  
% Tao2: added this. Naijia, please check
...
For this reason, both ``国家" (``country'', correct) and ``发言人" (``spokeswoman'', incorrect) are relaxed matched.  As relaexed approach always picks up the last candidate,  ``发言人" is yielded as a final output.
