...
% Tao: I think users are able to select lessions by difficulty and thus match their skills.
...
% Tao: It is better to  postpone mentioning the specific two languages. Perhpas mention it at the end of this paragraph. Too many Chinese (English) makes reading a little bit hard. In addition, our current system is to help a English speaker to learn Chinese, not suitable for a Chinese speaker to learn English.
User driven systems, however, lack rigor since the system never tests learners periodically to hone their skills. We seek to seamlessly merge learning and assessment into the same user session. %Learners are tested while they learn. 
