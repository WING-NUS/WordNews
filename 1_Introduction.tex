...
In the development of the system, we discovered two key issues that
affect system performance.  Both problems originate from the
difficulty of representing {\it context} to baseline implementations
of the natural language processing components.  We report on these
