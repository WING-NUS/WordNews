...
read news online everyday. In this paper, we propose a web 
browser extension that allows readers to learn a second language 
vocabulary while reading news online. To this end, we propose 
algorithms to disambiguate word sense and translate the words 
in new articles properly to target langauge.
...
We found that this machine translation based method significantly betters 
baselines in both coverage and accuracy. We also propose techniques 
for generating appropriate distractors for multiple-choice word 
mastery quizzes for assessing language learners. We conducted a user survey 
to evaluate our system.
%%Muthu: complete what is your finding and what we learn from it
