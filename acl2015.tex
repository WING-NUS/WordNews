...
Two key issues are practical word sense disambigution (WSD) to aid
translation quality and constructing the interactive tests. We start
with Microsoft's Bing translation API but employ additional dictionary
based heuristics that significantly improve translation quality over a
baseline in both coverage and accuracy. We also propose techniques for
generating appropriate distractors for multiple-choice word mastery
tests.  We have conducted a preliminary user survey that confirms the
need and viability of such a learning platform.
