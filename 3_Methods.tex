...
% E1:  Hackers are draining bank accounts via the Starbucks app
% http://money.cnn.com/2015/05/13/technology/hackers-starbucks-app
% E2: Verizon wants to eat Google's and Facebook's lunch
% http://money.cnn.com/2015/05/12/investing/verizon-aol-mobile-video-advertising/index.html

\begin{figure*}[ht]
\centering
\includegraphics[width=0.99\textwidth]{chrome_extension_new_2.png}
\caption{Merged screenshots of our Chrome extension on the CNN English
  article 
  {\it Verizon wants to eat Google's and Facebook's lunch}.
