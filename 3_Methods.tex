...
learning platform thus can be viewed as three logical components:
...
%\begin{table}[ht]
%\centering
%  \caption{The alignment of English and Chinese news categories and example categorical words.}
...
\begin{table}[ht]
\centering
  \caption{The alignment of English and Chinese news categories and example English categorical words.}
  \label{table:category}
  \begin{tabular}{| p{2.3cm} | p{2.3cm} | p{1.5cm} |}
    \hline
    ...
    \hline
     World &  Military, \qquad International, Social & attack \\
    \hline
    Finance & Finance & investment\\
    \hline
    Sports & Sports & score\\
    \hline
    Technology & Technology & phone \\
    \hline
...
tunable threshold $\delta=10$ more often than its average category
document frequency.  Note that a word can be categorized to multiple
categories under this scheme. Table~\ref{table:category} shows example
words under each category.
