...
% Tao: Erased "FROM" in the testing popover for now. 
% @Naijia, please fix the interface (replace "FROM" by a more proper word/phrase), and
% then fix the screenshot.
% http://money.cnn.com/2015/05/13/technology/hackers-starbucks-app
\begin{figure*}[ht]
\centering
\includegraphics[width=0.99\textwidth]{chrome_extension_new.png}
\caption{Merged screenshots of our Chrome extension on the CNN English
  article %{\it Treacherous journey to epicenter of deadly Nepal earthquake}.  
  {\it Hackers are draining bank accounts via the Starbucks app}.
