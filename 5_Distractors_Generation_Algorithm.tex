...
WordGap then selects the synonyms of $w1$, called $s1$.  WordGap
...
evaluations, we generate three distractors using each of two systems,
...
For each question, we deem a algorithm to be the winner if its three
...
level of difficulty.
>>>>>>> fd976961cbff775406d4079dda8c6c330330f48f
