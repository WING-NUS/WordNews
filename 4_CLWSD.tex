...
\subsection{Dataset}
 ...
 constructed using recent news data, it is a good representation for the use case in WordNews. To facilitate future research, we have released the dataset to the public{\footnote{%{\url{  https://kanghj.github.io/eng_chinese_news_clwsd_dataset/}}}}
